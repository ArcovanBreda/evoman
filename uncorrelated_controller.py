...
# implements uncorrelated controller structure for player
class uncorrelated_controller(Controller):
	def __init__(self, _n_hidden, stepsize):
	...
	def set(self,controller, n_inputs):
		...
		if self.n_hidden[0] > 0:
			...
			self.weights2 = controller[weights1_slice + 5:len(controller) - self.stepsize + 1].reshape((self.n_hidden[0], 5))
	...
	def control(self, inputs, controller):
		...
		if self.n_hidden[0]>0:
			...
			raise NotImplementedError #TODO should check whether controller handles sigmas correctly in this case
